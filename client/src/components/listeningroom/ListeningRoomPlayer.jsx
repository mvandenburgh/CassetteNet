...
function ListeningRoomPlayer({ listeningRoom }) {
  ...
  useInterval(() => {
    if (playerRef.current && playing && startedAt && songWasAt) {
  ...
  return (
    <div>
      ...
      <ReactPlayer
        ...
        url={listeningRoom?.mixtape.songs[currentSong?.index].listeningRoomPlaybackUrl}
        volume={musicVolume}
      />
      <ReactPlayer
        loop
